<template>
  <div class="fixed-content-footer">
    <div class="social-links">
      <a class="social-links__anchor" href="https://github.com/exbitron">
        <svg
      ...
      <a class="social-links__anchor" href="https://discord.gg/t6z5MN6dEK">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="social-links__image"
          width="24"
      ...
      <a class="social-links__anchor" href="https://twitter.com/exbitron">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="social-links__image"
          width="24"
    ...
    <div class="fixed-content-footer__copy">
      ...
      <span class="footer-copy__name">Exbitron.digital</span>
    </div>
  </div>
</template>
